...
- (void)viewDidLoad
{
    ...
    OCSevenSwitch *mySwitch = [[OCSevenSwitch alloc] initWithFrame:CGRectZero];
    ...
    OCSevenSwitch *mySwitch2 = [[OCSevenSwitch alloc] initWithFrame:CGRectMake(0, 0, 100, 10)];
    ...
    OCSevenSwitch *mySwitch3 = [[OCSevenSwitch alloc] initWithFrame:CGRectZero];
...
- (void)switchChanged:(OCSevenSwitch *)sender {
